...
class CandidateUpdateFragment : BaseFragment<FragmentCandidateUpdateBinding>(
    ...
    private fun observeData() {
        ...
        viewModel.afterupdateResult.observe(viewLifecycleOwner) { complateResult ->
        ...
        viewModel.candidateDocument.observe(viewLifecycleOwner) { item ->
            item?.let {
                binding.editText.setText(it.surname ?: "")
                binding.editText2.setText(it.name ?: "")
                binding.editText3.setText(it.patronymic ?: "")
                binding.editText4.setText(it.phonenumber ?: "")
                binding.editText5.setText(it.email ?: "")
                binding.editText7.setText(it.address ?: "")
                binding.editText6.setText(getFileNameFromUrl(it.cv) ?: "")
            }
        }
    }
